...
export const TopHeader: React.FC = () => {
  return (
        <Box className="text-light py-2 top" style={{ backgroundColor: "#008B8B", margin: 0, padding: 0 }}>
            <Box className="container d-flex flex-column flex-md-row justify-content-between align-items-center" m={0} p={0}>
                ...
                <span className="font-weight-bold ms-3">Email us:</span>
                    &nbsp;info@gibarestorative.com
                <span className="ms-3 font-weight-light">New Year Special - 10% off of any Weight Loss Program</span>
                </Text>
